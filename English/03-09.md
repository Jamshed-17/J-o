...
| Слово (русский)               | Слово (английский) | Буква | Определение (русский)                                                                                                                                                                    |
| :---------------------------- | :----------------- | :---- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Фигурные скобки**        | curly brackets     | f     | один из двух символов, которые ставятся вокруг слова, фразы или предложения в тексте, чтобы показать, что то, что находится между ними, следует рассматривать отдельно от основной части |
| **2. Обратная косая черта**   | backslash          | a     | указывает на то, что данные для указанной ячейки не могут быть найдены в базовой таблице фактов                                                                                          |
| **3. Доменное имя**           | domain             | (c)*  | если переменная объявлена, но ей не присвоено значение *Возможное несоответствие*                                                                                                        |
| **4. Ключевое значение**      | key value          | i     | механизм, включенный неформальным протоколом, который объекты принимают для предоставления косвенного доступа к своим свойствам                                                          |
| **5. Null тип**               | Null type          | g     | это специальное значение представляет «ничто», «пусто» или «значение неизвестно»                                                                                                         |
| **6. Строковый тип**          | string type        | d     | это любая последовательность символов, которая интерпретируется сценарием буквально                                                                                                      |
| **7. Встроенный объект**      | embedded object    | b     | это отдельный файл, не созданный в программе, который помещается в программу                                                                                                             |
| **8. Круглые скобки**         | parentheses        | (h)*  | использует это свойство, чтобы узнать количество символов в строке *Возможное несоответствие*                                                                                            |
| **9. Атрибут**                | attribute          | (e)*  | это данные, которые не являются объектом и не имеют методов *Возможное несоответствие*                                                                                                   |
| **10. Целое число**           | integer value      | j     | это целое число (не дробное), которое может быть положительным, отрицательным или нулевым                                                                                                |
| **11. Длина строки**          | length             | h     | использует это свойство, чтобы узнать количество символов в строке                                                                                                                       |
| **12. Элементарное значение** | primitive value    | e     | это данные, которые не являются объектом и не имеют методов                                                                                                                              |
| **13. Произвольный**          | undefined          | c     | если переменная объявлена, но ей не присвоено значение                                                                                                                                   |
| **14. Пустое значение**       | empty value        | k     | *определение отсутствует в общем списке*                                                                                                                                                 |
| **15. Сложные данные**        | complex data       | l     | используется для хранения коллекций различных значений и более сложных элементов и обычно является композицией других существующих типов данных                                          |
| **16. Скобки**                | brackets           | m     | они находятся на тех же клавишах, что и открывающая и закрывающая скобки на клавиатуре                                                                                                   |
| **17. Интерпретатор**         | interpreter        | n     | компьютерная программа, которая преобразует инструкции другой программы в форму, легко понимаемую компьютером                                                                            |