...
Определить сколько ты жившь:
```mysql
SELECT 
    TIMESTAMPDIFF(YEAR, '2006-03-06', CURRENT_TIMESTAMP) AS years_diff,
    TIMESTAMPDIFF(MONTH, '2006-03-06', CURRENT_TIMESTAMP) AS months_diff,
    TIMESTAMPDIFF(DAY, '2006-03-06', CURRENT_TIMESTAMP) AS days_diff,
    TIMESTAMPDIFF(HOUR, '2006-03-06', CURRENT_TIMESTAMP) AS hours_diff,
    TIMESTAMPDIFF(MINUTE, '2006-03-06', CURRENT_TIMESTAMP) AS minutes_diff,
    TIMESTAMPDIFF(SECOND, '2006-03-06', CURRENT_TIMESTAMP) AS seconds_diff;
```
